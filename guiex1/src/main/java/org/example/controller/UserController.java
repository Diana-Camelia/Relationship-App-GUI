...
/*
    ...
    public void deleteFriend(ActionEvent actionEvent) {
        ...
        if(user==null){
            ...
            a.setTitle("WARNING!");
            a.setContentText("Friend not selected! Please select a friend to continue!");
            a.show();
            return;
        }
        /*
        ...
        if(found1==null && found2 == null){
            Alert a=new Alert(Alert.AlertType.WARNING);
            a.setTitle("WARNING!");
            a.setContentText("Friendship doesn't exist!");
            a.show();
            return;
        }
        try {
    ...
    public void acceptRequest(ActionEvent actionEvent) {
        ...
        if(user==null){
            Alert a=new Alert(Alert.AlertType.WARNING);
            a.setTitle("WARNING");
            a.setContentText("Request not selected!");
            a.show();
            return;
        }
        ...
        if(found==null){
            Alert a=new Alert(Alert.AlertType.WARNING);
            a.setTitle("WARNING");
            a.setContentText("Request doesn't exist!");
            a.show();
            return;
        }
        ...
        try {
            ...
            Alert a=new Alert(Alert.AlertType.WARNING);
            a.setTitle("Success!");
            a.setContentText("Friendship request accepted!");
            a.show();
            populateTabels();
        } catch (ServiceException e) {
            Alert a=new Alert(Alert.AlertType.WARNING);
    ...
    public void declineRequest(ActionEvent actionEvent) {
        ...
        if(user==null){
            Alert a=new Alert(Alert.AlertType.WARNING);
            a.setTitle("WARNING!");
            a.setContentText("Requests not selected!");
            a.show();
            return;
        }
        var aux=service.findRequest(new Request<Integer>(user.getId(),owner.getId()));
